...
package-tauri-bundle-win:
	...
	powershell -NoProfile -Command 'if (Test-Path "dist\activitywatch") { Remove-Item "dist\activitywatch" -Recurse -Force }; New-Item -ItemType Directory -Force "dist\activitywatch" | Out-Null'
